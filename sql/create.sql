...
CREATE TABLE SOL_TRACK_PARAMETER (
...
CREATE TABLE SOL_TUNNEL_PARAMETER (
...
CREATE TABLE OP_TRACK_PARAMETER (	
...
CREATE TABLE OP_TRACK_TUNNEL_PARAMETER (
...
CREATE TABLE OP_TRACK_PLATFORM_PARAMETER (
	OPLP_id varchar PRIMARY KEY,
	PAR_id varchar REFERENCES PARAMETER,
	OPL_id varchar REFERENCES OP_TRACK_PLATFORM
);

CREATE TABLE OP_SIDING_PARAMETER (
	OSIP_id varchar PRIMARY KEY,
	PAR_id varchar REFERENCES PARAMETER,
	OSI_id varchar REFERENCES OP_SIDING
);

CREATE TABLE OP_SIDING_TUNNEL_PARAMETER (
